...
import lab2Model.RectangleCalculator;

/**
 *
 * @author owner
 */
@WebServlet(name = "RectangleCalculatorController", urlPatterns = {"/rectangleCalcControl"})
public class RectangleController extends HttpServlet {
    
    private static final String RESULT_PAGE = "/Lab2/Lab2_FormResult.jsp";
